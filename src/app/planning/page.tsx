          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SCENARIOS.map((scenario) => (
              ...
              >
                ...
                <p className="text-concrete text-sm leading-relaxed mb-8">
                  {scenario.desc}
                </p>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto flex flex-col lg:flex-row items-center gap-12">
             <div className="flex-1 text-obsidian">
               ...
               <h2 className="text-4xl font-bold font-syne uppercase mb-6 leading-tight">
                 Permitted Development<br />Compliance Checklist.
               </h2>
               <p className="text-lg font-dm-sans opacity-90 mb-8">
             ...
             <div className="w-full lg:w-96">
               <div className="bg-obsidian p-10 border border-obsidian/20">
                 ...
                 <input
                   ...
                   className="w-full bg-slate-900 border border-slate-800 py-4 px-6 text-white mb-6 focus:outline-none focus:border-brass"
                 />
