          ...
          <div className="planning-card bg-slate-900 border border-brass/30 p-10 relative">
            ...
            {result && (
              <div className="absolute inset-0 bg-slate-900 p-10 flex flex-col items-center justify-center text-center animate-in fade-in duration-500">
                {result === "permitted" && (
                  <>
                    <CheckCircle className="w-16 h-16 text-brass mb-6" />
                    <h3 className="text-2xl font-bold text-white font-syne mb-2 uppercase">LIKELY PERMITTED</h3>
                    <p className="text-concrete mb-8 max-w-sm">Your build is likely permitted development based on standard English rules.</p>
                ...
                {result === "review" && (
                  <>
                    ...
                    <p className="text-concrete mb-8 max-w-sm">Some aspects need professional checking, particularly regarding conservation status or heights.</p>
                    <Link href="/planning" className="text-technical text-brass border-b border-brass pb-1">READ FULL GUIDE →</Link>
                  </>
                )}
                {result === "denied" && (
                  <>
                    <Info className="w-16 h-16 text-steel mb-6" />
                    <h3 className="text-2xl font-bold text-white font-syne mb-2 uppercase">PERMISSION REQUIRED</h3>
                    <p className="text-concrete mb-8 max-w-sm">A full planning application is likely required for this project type or property.</p>
