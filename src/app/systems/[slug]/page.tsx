      ...
      <section className="py-32">
        <div className="container mx-auto px-6 flex flex-col lg:flex-row gap-32">
          <div className="lg:w-2/3 prose prose-invert prose-concrete max-w-none">
            ...
            <h2 className="text-3xl font-bold font-syne uppercase mt-16 mb-20">Comparison of Methods</h2>
            ...
            <h2 className="text-3xl font-bold font-syne uppercase mt-16 mb-20">Technical Specifications</h2>
