      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SYSTEMS.map((system) => (
            ...
            >
              <div className="text-4xl font-dm-mono text-steel group-hover:text-brass transition-colors mb-8">
                {system.id} /
              </div>
              ...
              <p className="text-concrete text-sm leading-relaxed mb-8 font-dm-sans">
                {system.desc}
              </p>
