...
export default function StorePage() {
  return (
    <main className="min-h-screen bg-obsidian">
      ...
      <section className="bg-obsidian py-64 border-t border-slate-900">
        <div className="container mx-auto px-6 text-center">
          <span className="text-technical text-brass mb-8 block">BUILDER SUPPORT</span>
          <h2 className="text-4xl font-bold text-white font-syne uppercase mb-20">Expert Advice on Every Product.</h2>
